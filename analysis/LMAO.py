...
class AnimatePlay2:
    def __init__(self, play_df, plot_size_len, field_prob_df=None) -> None:
        ...
        self._ax_field = p3.Axes3D(self._fig)
        ...
        self.ani = animation.FuncAnimation(
            ...
            interval=50, init_func=self.setup_plot, blit=False)
    ...
    def setup_plot(self):
        ...
        self._frame_text = self._ax_field.text(5, 51, 0,0, fontsize=15, color='white', ha='center')
        self._event_text = self._ax_field.text(5, 49, 0, 0, None, fontsize=10, color='white', ha='center')
        self._ball_loc_text = self._ax_field.text(5, 47, 0, None, fontsize=12, color='white', ha='center')
        self._pass_arr_text = self._ax_field.text(5, 45, 0, None, fontsize=12, color='white', ha='center')
