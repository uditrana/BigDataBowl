...
class CompProbModel(torch.nn.Module):
    def __init__(self, a_max=7.25, s_max=9.25, avg_ball_speed=20.0, tti_sigma=0.5, tti_lambda_off=1.0, tti_lambda_def=1.0, tuning=None):
        super().__init__()
    ...
    def forward(self, frame):
        ...
        if self.tuning == TuningParam.sigma:
            ...
            reach_vecs = self.field_locs.unsqueeze(0) - ball_start.unsqueeze(1)
